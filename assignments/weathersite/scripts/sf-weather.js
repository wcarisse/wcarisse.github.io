...
weatherObject.open('GET', 'https://api.wunderground.com/api/11258ffcc177b5a5/conditions/q/OR/Springfield.json', true);
...
forecastObject.open('GET', 'https://api.wunderground.com/api/11258ffcc177b5a5/forecast/q/OR/Springfield.json', true);
